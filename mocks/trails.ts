    ...
    modules: [
      {
        ...
        lessons: [
          ...
          {
            id: 'rf-m0-l3',
            title: 'Exercício: Card de perfil',
            duration: '30min',
            type: 'code',
            done: true,
          },
      ...
      },
      {
        ...
        lessons: [
          ...
          {
            id: 'rf-m2-l2',
            title: 'Leitura: Regras dos hooks',
            duration: '06min',
            type: 'doc',
            done: true,
          },
      ...
      },
      {
        ...
        lessons: [
          ...
          {
            id: 'rf-m3-l2',
            title: 'Patterns: Provider composto',
            duration: '18min',
            type: 'video',
            done: false,
          },
          {
            id: 'rf-m3-l3',
            title: 'Exercício: Theme switcher',
            duration: '35min',
            type: 'code',
            done: false,
          },
      ...
      },
      {
        ...
        lessons: [
          ...
          {
            id: 'rf-m4-l3',
            title: 'Exercício: Otimizando lista',
            duration: '40min',
            type: 'code',
            done: false,
          },
    ...
    modules: [
      {
        ...
        lessons: [
          {
            id: 'an-m0-l0',
            title: 'Do Pages Router ao App Router',
            duration: '16min',
            type: 'video',
            done: true,
          },
          {
            id: 'an-m0-l1',
            title: 'File-system routing avançado',
            duration: '20min',
            type: 'video',
            done: true,
          },
          ...
          {
            id: 'an-m0-l3',
            title: 'Exercício: dashboard aninhado',
            duration: '45min',
            type: 'code',
            done: true,
          },
      ...
      },
      {
        ...
        lessons: [
          ...
          {
            id: 'an-m1-l3',
            title: 'Exercício: form com Server Action',
            duration: '50min',
            type: 'code',
            done: false,
          },
    ...
    modules: [
      {
        ...
        lessons: [
          {
            id: 'ud-m0-l0',
            title: 'Por que devs precisam pensar design',
            duration: '11min',
            type: 'video',
            done: true,
          },
          ...
          {
            id: 'ud-m0-l2',
            title: 'Contraste, cor e acessibilidade',
            duration: '18min',
            type: 'video',
            done: true,
          },
          {
            id: 'ud-m0-l3',
            title: 'Exercício: auditar uma UI',
            duration: '30min',
            type: 'doc',
            done: true,
          },
      ...
      },
      {
        ...
        lessons: [
          {
            id: 'ud-m1-l0',
            title: 'Escala tipográfica e ritmo vertical',
            duration: '20min',
            type: 'video',
            done: false,
            current: true,
