...
export default function ConsultaScreen() {
  ...
  async function handleSubmit() {
    ...
    try {
      const response = await api.post<GenerateTrailResult>(
        '/ai/generate-trail',
        {
      ...
      setErrorMessage(
        'A IA está temporariamente indisponível para gerar novas trilhas. Que tal tentar novamente em alguns instantes?'
      );
    } finally {
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          <View style={styles.hero}>
            <View style={styles.topRow}>
              <Text style={styles.badge}>Milestone Final</Text>
          ...
          <View style={styles.card}>
            ...
            <TextInput
              ...
              style={[styles.input, styles.textArea, isSubmitting ? styles.disabledInput : null]}
            ...
            <TrailButton
              label={isSubmitting ? 'Gerando trilha...' : 'Gerar trilha'}
